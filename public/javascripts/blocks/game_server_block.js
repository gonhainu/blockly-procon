Blockly.Blocks["server_connect"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField("値の初期化");
    this.appendStatementInput("init_value").setCheck(null);
    this.appendDummyInput();
    this.appendDummyInput()
      .appendField(
    ...
    this.appendDummyInput().appendField("もし自分のターンなら実行");
    this.appendStatementInput("my_turn").setCheck(null);
    this.appendDummyInput()
...
Blockly.Blocks["get_ready"] = {
  init: function () {
    this.appendDummyInput().appendField("%{WAIT_MY_TURN}");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(195);
